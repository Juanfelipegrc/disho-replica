                    ...
                    <div className="col-12 col-md-8 col-lg-8 my-3 my-lg-0">
                      <div className='ratio ratio-21x9 delivery-services-container'>
                        ...
                        <div className="card-overlay d-flex flex-column justify-content-center align-items-center">
                          ...
                          <div id="carousel2" className="carousel slide w-50" data-bs-ride="carousel" data-bs-interval="3000">
                            <div className="carousel-inner">
                              <div className="carousel-item active" >
                                <h2 className=' text-center'>Own Production</h2>
                              </div>
                              <div className="carousel-item">
                                <h2 className=' text-center'>Organic Farm</h2>
                              </div>
                              <div className="carousel-item">
                                <h2 className=' text-center'>Delivery Services</h2>
                              </div>
                            </div>
