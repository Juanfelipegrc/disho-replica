...
import { milkBanner, onlyPears, wasteFoodNoShape } from '../../../assets'
import { useNavigate } from 'react-router-dom';

export const Section1Shop3 = () => {


    const navigate = useNavigate();

    useEffect(() => {
        const carousel = document.getElementById('carouselShop3');
  ...
  return (
    ...
    <div className="container-fluid container-md-fluid container-lg border border-0 rounded-0 pt-5">
            <div id="carouselShop3" className="carousel carousel-dark slide bg-white border border-0 rounded-0 p-0 shadow" data-bs-ride="carousel">
                <div className="carousel-indicators">
                    <button type="button" data-bs-target="#carouselShop3" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#carouselShop3" data-bs-slide-to="1" aria-label="Slide 2"></button>
                    <button type="button" data-bs-target="#carouselShop3" data-bs-slide-to="2" aria-label="Slide 3"></button>
                </div>
                ...
                <div className="carousel-inner border-0 rounded-5 p-0">
                    <div className="carousel-item active">
                        <div className="container-fluid container-md-fluid container-lg slider-home-3 d-flex justify-content-center align-items-center d-none d-md-flex d-lg-flex p-0 ">
                            ...
                            <img className='w-50 object-fit-cover mt-n5' src={wasteFoodNoShape} alt="" />
                        </div>
                        {/* SM */}
                        <div className="container-fluid border border-0 rounded-5 d-block d-md-none d-lg-none card border-0 m-0 p-0 py-5 py-lg-0 ">
                            <img src={wasteFoodNoShape} className="card-img me-n5 pt-5" alt="..."/>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="container-fluid container-md-fluid container-lg slider-home-3 d-flex justify-content-center align-items-center d-none d-md-flex d-lg-flex p-0">
                            ...
                            <img className='w-50 object-fit-cover mt-n5' src={onlyPears} alt="" />
                        </div>
                        {/* SM */}
                        <div className="container-fluid border border-0 rounded-5 d-block d-md-none d-lg-none card border-0 m-0 p-0 py-5 py-lg-0">
                            <img src={onlyPears} className="card-img me-n5 pt-5" alt="..."/>
                            <div className="card-img-overlay m-3">
                                <h1 className=' text-danger font-big-1 text-start'>Up to 70% Off</h1>
