...
import { healthyFood, shape } from '../../../assets'

export const Section7Home1 = () => {
  return (
    <>
        ...
        <div className="container-fluid d-flex align-items-center justify-content-center container-fluid position-relative bg-middle-gray py-5 m-0 overflow-hidden">
            <div className="row">
                ...
                <div className="d-none d-md-none d-lg-flex justify-content-center position-absolute top-50 start-100 translate-middle overflow-hidden">
                <img className='w-50 opacity-25 ' src={shape} alt="" />
                </div>
                <div className="d-none d-md-block d-lg-none justify-content-center position-absolute top-50 start-25 translate-middle overflow-hidden ms-5 mt-5">
                <img className='w-75 opacity-25 ms-5 mt-5' src={shape} alt="" />
                </div>
                <div className="d-flex d-md-none d-lg-none justify-content-center position-absolute top-50 start-25 translate-middle overflow-hidden ms-5 ">
                <img className='w-100 opacity-25 ms-5 ' src={shape} alt="" />
                </div>
            </div>
        </div>
